 ...
 * - Stage 3: Blog Selection & DUAL Article Planning (selects 1 of 6 ideas, creates 2 outlines)
 * - Stage 6: DUAL Blog Draft Generation (2 articles ~750 words each)
 * - Stage 7: DUAL Article Refinement (refines both articles)
 *
...
const STAGE_TOKEN_ESTIMATES = {
  ...
  3: { input: 2500, output: 600 },   // Blog Selection & Dual Outline (increased for 2 outlines)
  ...
  7: { input: 5000, output: 2400 },  // DUAL Refinement (refines both articles)
